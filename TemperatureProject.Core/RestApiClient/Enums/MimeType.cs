...
namespace TemperatureProject.Core.RestApiClient.Enums
{
    public class MimeType
    {
        ...
        public static readonly MimeType ApplicationXJavascript = new MimeType("application/x-javascript");

        ///<summary>24bit Linear PCM audio at 8-48kHz, 1-N channels; Defined in RFC 3190</summary>
        public static readonly MimeType AudioL24 = new MimeType("audio/L24");
        ...
        public static readonly MimeType ApplicationJson = new MimeType("application/json");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Name.Equals(mimeType.Name);
        }
